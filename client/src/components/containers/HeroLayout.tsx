...
const Hero = () => {
  ...
  return (
    <main ref={heroSectionRef} className="md:flex m-5 md:h-screen h-full gap-5 flex-row justify-center items-start">
      ...
      <section className="flex-row mt-12 mb-5 justify-center md:w-1/2">
