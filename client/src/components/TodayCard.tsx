...
const TodayCard = ({praznik, post, crveno_slovo, slika}: TodayCardComponnetType) => {
  console.log(slika)
  return (
    <div className="w-full rounded-full h-auto cursor-pointer transition-all flex-row  shadow-md items-center bg-amber-100">
      <div className="flex justify-around items-center m-3">
        <img className="md:w-30 w-20 rounded-full" src={slika ?? ''} alt="" />
